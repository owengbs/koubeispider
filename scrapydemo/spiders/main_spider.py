...
class DmozSpider(CrawlSpider):
    ...
    rules = (
        ...
        # http://www.mama.cn/ask/
        Rule(SgmlLinkExtractor(allow=('http://www.mama.cn/ask/list/c0-s\d+-all-p\d+.html',), )),
        Rule(SgmlLinkExtractor(allow=('http://www.mama.cn/ask/q\d+-p\d+.html',),
                               restrict_xpaths=('//ul[@class="aFilter"]/li/div[@class="aCon"]/p[@class="htitle"]/a','//div[@class="pagination"]/div[@class="pg"]/a')),
